...
IXHTAB_FORCE_INLINE ixhtab_group_t ixhtab_group_load (const unsigned char *p) {
  return _mm_cvtsi64_si128 (*(const long long *) p);
}
IXHTAB_FORCE_INLINE unsigned int ixhtab_match_mask (ixhtab_group_t g, unsigned char h7_val) {
  __m128i h7_vec = _mm_set1_epi8 ((char) h7_val);
  return (unsigned int) _mm_movemask_epi8 (_mm_cmpeq_epi8 (g, h7_vec)) & 0xff;
}
IXHTAB_FORCE_INLINE unsigned int ixhtab_match_empty (ixhtab_group_t g) {
...
IXHTAB_FORCE_INLINE uint64_t ixhtab_match_mask (ixhtab_group_t g, unsigned char h7_val) {
  uint64_t cmp = g ^ (IXHTAB_SWAR_LSB * h7_val);
  return (cmp - IXHTAB_SWAR_LSB) & ~cmp & IXHTAB_SWAR_MSB;
}
IXHTAB_FORCE_INLINE uint64_t ixhtab_match_empty (ixhtab_group_t g) { return g & IXHTAB_SWAR_MSB; }
...
#define DEFINE_IXHTAB(El, Hash, Eq)                                                                        \
  ...
  IXHTAB_FORCE_INLINE void ixhtab_destroy_##El (struct ixhtab_##El *t) {                                   \
    ...
    free (t->dir);                                                                                         \
                                                                                                           ...
                                                                                                           \
  IXHTAB_FORCE_INLINE bool ixhtab_perform_##El (struct ixhtab_##El *t, El *el, enum ixhtab_action action,  \
                                                El **res) {                                                \
